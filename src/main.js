...
function updateSelectedCharacter(updater) {
          ...
          .map(
            (skill, index) => `
              <article class="repeatable-card">
                ...
                <div class="field-grid four-up compact-grid">
                  ${createLabeledInput({ label: 'Skill Name', name: `skill.name.${skill.id}`, value: skill.name, placeholder: 'Martial Arts, Programming...' })}
