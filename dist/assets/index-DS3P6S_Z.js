 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zl(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function Gr(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(Zl())}function Ql(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function Jl(){return Br.NODE_ADMIN===!0}function Xl(){try{return typeof indexedDB=="object"}catch{return!1}}function ec(){return new Promise((t,e)=>{try{let n=!0;const i="validate-browser-context-for-indexeddb-analytics-module",s=self.indexedDB.open(i);s.onsuccess=()=>{s.result.close(),n||self.indexedDB.deleteDatabase(i),t(!0)},s.onupgradeneeded=()=>{n=!1},s.onerror=()=>{var r;e(((r=s.error)==null?void 0:r.message)||"")}}catch(n){e(n)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zr=function(t){let e={},n={},i={},s="";try{const r=t.split(".");e=kt(ii(r[0])||""),n=kt(ii(r[1])||""),s=r[2],i=n.d||{},delete n.d}catch{}return{header:e,claims:n,data:i,signature:s}},sc=function(t){const e=zr(t),n=e.claims;return!!n&&typeof n=="object"&&n.hasOwnProperty("iat")},rc=function(t){const e=zr(t).claims;return typeof e=="object"&&e.admin===!0};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nc{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(Rc(n)){const i=n.getImmediate();return`${i.library}/${i.version}`}else return null}).filter(n=>n).join(" ")}}function Rc(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const ai="@firebase/app",Os="0.14.12";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const li="[DEFAULT]",sh={[ai]:"fire-core",[xc]:"fire-core-compat",[Dc]:"fire-analytics",[Pc]:"fire-analytics-compat",[Mc]:"fire-app-check",[Oc]:"fire-app-check-compat",[Lc]:"fire-auth",[Fc]:"fire-auth-compat",[$c]:"fire-rtdb",[Bc]:"fire-data-connect",[Hc]:"fire-rtdb-compat",[Wc]:"fire-fn",[Uc]:"fire-fn-compat",[qc]:"fire-iid",[jc]:"fire-iid-compat",[Gc]:"fire-fcm",[Vc]:"fire-fcm-compat",[zc]:"fire-perf",[Kc]:"fire-perf-compat",[Yc]:"fire-rc",[Zc]:"fire-rc-compat",[Qc]:"fire-gcs",[Jc]:"fire-gcs-compat",[Xc]:"fire-fst",[th]:"fire-fst-compat",[eh]:"fire-vertex","fire-js":"fire-js",[nh]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const an=new Map,rh=new Map,ci=new Map;function Ms(t,e){try{t.container.addComponent(e)}catch(n){ue.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function ln(t){const e=t.name;if(ci.has(e))return ue.debug(`There were multiple attempts to register component ${e}.`),!1;ci.set(e,t);for(const n of an.values())Ms(n,t);for(const n of rh.values())Ms(n,t);return!0}function oh(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}function ah(t){return t==null?!1:t.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hh=ih;function Jr(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const i={name:li,automaticDataCollectionEnabled:!0,...e},s=i.name;if(typeof s!="string"||!s)throw ye.create("bad-app-name",{appName:String(s)});if(n||(n=jr()),!n)throw ye.create("no-options");const r=an.get(s);if(r){if(on(n,r.options)&&on(i,r.config))return r;throw ye.create("duplicate-app",{appName:s})}const o=new fc(s);for(const l of ci.values())o.addComponent(l);const a=new ch(n,i,o);return an.set(s,a),a}function dh(t=li){const e=an.get(t);if(!e&&t===li&&jr())return Jr();if(!e)throw ye.create("no-app",{appName:t});return e}function je(t,e,n){let i=sh[t]??t;n&&(i+=`-${n}`);const s=i.match(/\s|\//),r=e.match(/\s|\//);if(s||r){const o=[`Unable to register library "${i}" with version "${e}":`];s&&o.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&r&&o.push("and"),r&&o.push(`version name "${e}" contains illegal characters (whitespace or "/")`),ue.warn(o.join(" "));return}ln(new Tt(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const uh="firebase-heartbeat-database",fh=1,It="firebase-heartbeat-store";let qn=null;function Xr(){return qn||(qn=Tc(uh,fh,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(It)}catch(n){console.warn(n)}}}}).catch(t=>{throw ye.create("idb-open",{originalErrorMessage:t.message})})),qn}async function ph(t){try{const n=(await Xr()).transaction(It),i=await n.objectStore(It).get(eo(t));return await n.done,i}catch(e){if(e instanceof Ht)ue.warn(e.message);else{const n=ye.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});ue.warn(n.message)}}}async function Ls(t,e){try{const i=(await Xr()).transaction(It,"readwrite");await i.objectStore(It).put(e,eo(t)),await i.done}catch(n){if(n instanceof Ht)ue.warn(n.message);else{const i=ye.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});ue.warn(i.message)}}}function eo(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wh(t){ln(new Tt("platform-logger",e=>new Nc(e),"PRIVATE")),ln(new Tt("heartbeat",e=>new _h(e),"PRIVATE")),je(ai,Os,t),je(ai,Os,"esm2020"),je("fire-js","")}wh("");var Ch="firebase",Sh="12.13.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pi="5",oo="v",ao="s",lo="r",co="f",ho=/(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/,uo="ls",fo="p",di="ac",po="websocket",mo="long_polling";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jn={},Gn={};function Di(t){const e=t.toString();return jn[e]||(jn[e]=new qh),jn[e]}function jh(t,e){const n=t.toString();return Gn[n]||(Gn[n]=e()),Gn[n]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sd(t,e){return Fe(t.name,e.name)}function $i(t,e){return Fe(t,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ui;function Ed(t){ui=t}const Ao=function(t){return typeof t=="number"?"number:"+ro(t):"string:"+t},No=function(t){if(t.isLeafNode()){const e=t.val();m(typeof e=="string"||typeof e=="number"||typeof e=="object"&&oe(e,".sv"),"Priority must be a string or number.")}else m(t===ui||t.isEmpty(),"priority of unexpected type.");m(t===ui||t.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Po(t){return{type:"value",snapshotNode:t}}function Xe(t,e){return{type:"child_added",snapshotNode:e,childName:t}}function Rt(t,e){return{type:"child_removed",snapshotNode:e,childName:t}}function xt(t,e,n){return{type:"child_changed",snapshotNode:e,childName:t,oldSnap:n}}function Md(t,e){return{type:"child_moved",snapshotNode:e,childName:t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bi{constructor(e){this.index_=e}updateChild(e,n,i,s,r,o){m(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const a=e.getImmediateChild(n);return a.getChild(s).equals(i.getChild(s))&&a.isEmpty()===i.isEmpty()||(o!=null&&(i.isEmpty()?e.hasChild(n)?o.trackChildChange(Rt(n,a)):m(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):a.isEmpty()?o.trackChildChange(Xe(n,i)):o.trackChildChange(xt(n,i,a))),e.isLeafNode()&&i.isEmpty())?e:e.updateImmediateChild(n,i).withIndex(this.index_)}updateFullNode(e,n,i){return i!=null&&(e.isLeafNode()||e.forEachChild(M,(s,r)=>{n.hasChild(s)||i.trackChildChange(Rt(s,r))}),n.isLeafNode()||n.forEachChild(M,(s,r)=>{if(e.hasChild(s)){const o=e.getImmediateChild(s);o.equals(r)||i.trackChildChange(xt(s,r,o))}else i.trackChildChange(Xe(s,r))})),n.withIndex(this.index_)}updatePriority(e,n){return e.isEmpty()?w.EMPTY_NODE:e.updatePriority(n)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fn(){return{value:null,children:new Map}}function at(t,e,n){if(S(e))t.value=n,t.children.clear();else if(t.value!==null)t.value=t.value.updateChild(e,n);else{const i=C(e);t.children.has(i)||t.children.set(i,fn());const s=t.children.get(i);e=R(e),at(s,e,n)}}function fi(t,e){if(S(e))return t.value=null,t.children.clear(),!0;if(t.value!==null){if(t.value.isLeafNode())return!1;{const n=t.value;return t.value=null,n.forEachChild(M,(i,s)=>{at(t,new N(i),s)}),fi(t,e)}}else if(t.children.size>0){const n=C(e);return e=R(e),t.children.has(n)&&fi(t.children.get(n),e)&&t.children.delete(n),t.children.size===0}else return!0}function pi(t,e,n){t.value!==null?n(e,t.value):Bd(t,(i,s)=>{const r=new N(e.toString()+"/"+i);pi(s,r,n)})}function Bd(t,e){t.children.forEach((n,i)=>{e(i,n)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ie;(function(t){t[t.OVERWRITE=0]="OVERWRITE",t[t.MERGE=1]="MERGE",t[t.ACK_USER_WRITE=2]="ACK_USER_WRITE",t[t.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"})(ie||(ie={}));function Do(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function Wi(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function Ui(t){return{fromUser:!1,fromServer:!0,queryId:t,tagged:!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tn(t,e){return{eventCache:t,serverCache:e}}function bt(t,e,n,i){return Tn(new De(e,n,i),t.serverCache)}function Oo(t,e,n,i){return Tn(t.eventCache,new De(e,n,i))}function mi(t){return t.eventCache.isFullyInitialized()?t.eventCache.getNode():null}function Oe(t){return t.serverCache.isFullyInitialized()?t.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qi(t,e){return Bo(e,t)}function Yd(t,e,n,i,s){m(i>t.lastWriteId,"Stacking an older write on top of newer ones"),s===void 0&&(s=!0),t.allWrites.push({path:e,snap:n,writeId:i,visible:s}),s&&(t.visibleWrites=wt(t.visibleWrites,e,n)),t.lastWriteId=i}function Zd(t,e){for(let n=0;n<t.allWrites.length;n++){const i=t.allWrites[n];if(i.writeId===e)return i}return null}function Qd(t,e){const n=t.allWrites.findIndex(a=>a.writeId===e);m(n>=0,"removeWrite called with nonexistent writeId.");const i=t.allWrites[n];t.allWrites.splice(n,1);let s=i.visible,r=!1,o=t.allWrites.length-1;for(;s&&o>=0;){const a=t.allWrites[o];a.visible&&(o>=n&&Jd(a,i.path)?s=!1:J(i.path,a.path)&&(r=!0)),o--}if(s){if(r)return Xd(t),!0;if(i.snap)t.visibleWrites=or(t.visibleWrites,i.path);else{const a=i.children;j(a,l=>{t.visibleWrites=or(t.visibleWrites,L(i.path,l))})}return!0}else return!1}function Jd(t,e){if(t.snap)return J(t.path,e);for(const n in t.children)if(t.children.hasOwnProperty(n)&&J(L(t.path,n),e))return!0;return!1}function Xd(t){t.visibleWrites=Lo(t.allWrites,eu,I()),t.allWrites.length>0?t.lastWriteId=t.allWrites[t.allWrites.length-1].writeId:t.lastWriteId=-1}function eu(t){return t.visible}function Lo(t,e,n){let i=re.empty();for(let s=0;s<t.length;++s){const r=t[s];if(e(r)){const o=r.path;let a;if(r.snap)J(n,o)?(a=V(n,o),i=wt(i,a,r.snap)):J(o,n)&&(a=V(o,n),i=wt(i,I(),r.snap.getChild(a)));else if(r.children){if(J(n,o))a=V(n,o),i=rr(i,a,r.children);else if(J(o,n))if(a=V(o,n),S(a))i=rr(i,I(),r.children);else{const l=Ze(r.children,C(a));if(l){const c=l.getChild(R(a));i=wt(i,I(),c)}}}else throw st("WriteRecord should have .snap or .children")}}return i}function Fo(t,e,n,i,s){if(!i&&!s){const r=$e(t.visibleWrites,e);if(r!=null)return r;{const o=ve(t.visibleWrites,e);if(_i(o))return n;if(n==null&&!gi(o,I()))return null;{const a=n||w.EMPTY_NODE;return et(o,a)}}}else{const r=ve(t.visibleWrites,e);if(!s&&_i(r))return n;if(!s&&n==null&&!gi(r,I()))return null;{const o=function(c){return(c.visible||s)&&(!i||!~i.indexOf(c.writeId))&&(J(c.path,e)||J(e,c.path))},a=Lo(t.allWrites,o,e),l=n||w.EMPTY_NODE;return et(a,l)}}}function tu(t,e,n){let i=w.EMPTY_NODE;const s=$e(t.visibleWrites,e);if(s)return s.isLeafNode()||s.forEachChild(M,(r,o)=>{i=i.updateImmediateChild(r,o)}),i;if(n){const r=ve(t.visibleWrites,e);return n.forEachChild(M,(o,a)=>{const l=et(ve(r,new N(o)),a);i=i.updateImmediateChild(o,l)}),ar(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}else{const r=ve(t.visibleWrites,e);return ar(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}}function nu(t,e,n,i,s){m(i||s,"Either existingEventSnap or existingServerSnap must exist");const r=L(e,n);if(gi(t.visibleWrites,r))return null;{const o=ve(t.visibleWrites,r);return _i(o)?s.getChild(n):et(o,s.getChild(n))}}function iu(t,e,n,i){const s=L(e,n),r=$e(t.visibleWrites,s);if(r!=null)return r;if(i.isCompleteForChild(n)){const o=ve(t.visibleWrites,s);return et(o,i.getNode().getImmediateChild(n))}else return null}function su(t,e){return $e(t.visibleWrites,e)}function ru(t,e,n,i,s,r,o){let a;const l=ve(t.visibleWrites,e),c=$e(l,I());if(c!=null)a=c;else if(n!=null)a=et(l,n);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const d=[],h=o.getCompare(),f=r?a.getReverseIteratorFrom(i,o):a.getIteratorFrom(i,o);let g=f.getNext();for(;g&&d.length<s;)h(g,i)!==0&&d.push(g),g=f.getNext();return d}else return[]}function ou(){return{visibleWrites:re.empty(),allWrites:[],lastWriteId:-1}}function mn(t,e,n,i){return Fo(t.writeTree,t.treePath,e,n,i)}function ji(t,e){return tu(t.writeTree,t.treePath,e)}function lr(t,e,n,i){return nu(t.writeTree,t.treePath,e,n,i)}function gn(t,e){return su(t.writeTree,L(t.treePath,e))}function au(t,e,n,i,s,r){return ru(t.writeTree,t.treePath,e,n,i,s,r)}function Gi(t,e,n){return iu(t.writeTree,t.treePath,e,n)}function $o(t,e){return Bo(L(t.treePath,e),t.writeTree)}function Bo(t,e){return{treePath:t,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cu{getCompleteChild(e){return null}getChildAfterChild(e,n,i){return null}}const Ho=new cu;class Vi{constructor(e,n,i=null){this.writes_=e,this.viewCache_=n,this.optCompleteServerCache_=i}getCompleteChild(e){const n=this.viewCache_.eventCache;if(n.isCompleteForChild(e))return n.getNode().getImmediateChild(e);{const i=this.optCompleteServerCache_!=null?new De(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Gi(this.writes_,e,i)}}getChildAfterChild(e,n,i){const s=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:Oe(this.viewCache_),r=au(this.writes_,s,n,1,i,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hu(t){return{filter:t}}function du(t,e){m(e.eventCache.getNode().isIndexed(t.filter.getIndex()),"Event snap not indexed"),m(e.serverCache.getNode().isIndexed(t.filter.getIndex()),"Server snap not indexed")}function uu(t,e,n,i,s){const r=new lu;let o,a;if(n.type===ie.OVERWRITE){const c=n;c.source.fromUser?o=yi(t,e,c.path,c.snap,i,s,r):(m(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered()&&!S(c.path),o=_n(t,e,c.path,c.snap,i,s,a,r))}else if(n.type===ie.MERGE){const c=n;c.source.fromUser?o=pu(t,e,c.path,c.children,i,s,r):(m(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered(),o=vi(t,e,c.path,c.children,i,s,a,r))}else if(n.type===ie.ACK_USER_WRITE){const c=n;c.revert?o=_u(t,e,c.path,i,s,r):o=mu(t,e,c.path,c.affectedTree,i,s,r)}else if(n.type===ie.LISTEN_COMPLETE)o=gu(t,e,n.path,i,r);else throw st("Unknown operation type: "+n.type);const l=r.getChanges();return fu(e,o,l),{viewCache:o,changes:l}}function fu(t,e,n){const i=e.eventCache;if(i.isFullyInitialized()){const s=i.getNode().isLeafNode()||i.getNode().isEmpty(),r=mi(t);(n.length>0||!t.eventCache.isFullyInitialized()||s&&!i.getNode().equals(r)||!i.getNode().getPriority().equals(r.getPriority()))&&n.push(Po(mi(e)))}}function Wo(t,e,n,i,s,r){const o=e.eventCache;if(gn(i,n)!=null)return e;{let a,l;if(S(n))if(m(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const c=Oe(e),d=c instanceof w?c:w.EMPTY_NODE,h=ji(i,d);a=t.filter.updateFullNode(e.eventCache.getNode(),h,r)}else{const c=mn(i,Oe(e));a=t.filter.updateFullNode(e.eventCache.getNode(),c,r)}else{const c=C(n);if(c===".priority"){m(be(n)===1,"Can't have a priority with additional path components");const d=o.getNode();l=e.serverCache.getNode();const h=lr(i,n,d,l);h!=null?a=t.filter.updatePriority(d,h):a=o.getNode()}else{const d=R(n);let h;if(o.isCompleteForChild(c)){l=e.serverCache.getNode();const f=lr(i,n,o.getNode(),l);f!=null?h=o.getNode().getImmediateChild(c).updateChild(d,f):h=o.getNode().getImmediateChild(c)}else h=Gi(i,c,e.serverCache);h!=null?a=t.filter.updateChild(o.getNode(),c,h,d,s,r):a=o.getNode()}}return bt(e,a,o.isFullyInitialized()||S(n),t.filter.filtersNodes())}}function _n(t,e,n,i,s,r,o,a){const l=e.serverCache;let c;const d=o?t.filter:t.filter.getIndexedFilter();if(S(n))c=d.updateFullNode(l.getNode(),i,null);else if(d.filtersNodes()&&!l.isFiltered()){const g=l.getNode().updateChild(n,i);c=d.updateFullNode(l.getNode(),g,null)}else{const g=C(n);if(!l.isCompleteForPath(n)&&be(n)>1)return e;const _=R(n),O=l.getNode().getImmediateChild(g).updateChild(_,i);g===".priority"?c=d.updatePriority(l.getNode(),O):c=d.updateChild(l.getNode(),g,O,_,Ho,null)}const h=Oo(e,c,l.isFullyInitialized()||S(n),d.filtersNodes()),f=new Vi(s,h,r);return Wo(t,h,n,s,f,a)}function yi(t,e,n,i,s,r,o){const a=e.eventCache;let l,c;const d=new Vi(s,e,r);if(S(n))c=t.filter.updateFullNode(e.eventCache.getNode(),i,o),l=bt(e,c,!0,t.filter.filtersNodes());else{const h=C(n);if(h===".priority")c=t.filter.updatePriority(e.eventCache.getNode(),i),l=bt(e,c,a.isFullyInitialized(),a.isFiltered());else{const f=R(n),g=a.getNode().getImmediateChild(h);let _;if(S(f))_=i;else{const k=d.getCompleteChild(h);k!=null?Mi(f)===".priority"&&k.getChild(ko(f)).isEmpty()?_=k:_=k.updateChild(f,i):_=w.EMPTY_NODE}if(g.equals(_))l=e;else{const k=t.filter.updateChild(a.getNode(),h,_,f,d,o);l=bt(e,k,a.isFullyInitialized(),t.filter.filtersNodes())}}}return l}function cr(t,e){return t.eventCache.isCompleteForChild(e)}function pu(t,e,n,i,s,r,o){let a=e;return i.foreach((l,c)=>{const d=L(n,l);cr(e,C(d))&&(a=yi(t,a,d,c,s,r,o))}),i.foreach((l,c)=>{const d=L(n,l);cr(e,C(d))||(a=yi(t,a,d,c,s,r,o))}),a}function hr(t,e,n){return n.foreach((i,s)=>{e=e.updateChild(i,s)}),e}function vi(t,e,n,i,s,r,o,a){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let l=e,c;S(n)?c=i:c=new D(null).setTree(n,i);const d=e.serverCache.getNode();return c.children.inorderTraversal((h,f)=>{if(d.hasChild(h)){const g=e.serverCache.getNode().getImmediateChild(h),_=hr(t,g,f);l=_n(t,l,new N(h),_,s,r,o,a)}}),c.children.inorderTraversal((h,f)=>{const g=!e.serverCache.isCompleteForChild(h)&&f.value===null;if(!d.hasChild(h)&&!g){const _=e.serverCache.getNode().getImmediateChild(h),k=hr(t,_,f);l=_n(t,l,new N(h),k,s,r,o,a)}}),l}function mu(t,e,n,i,s,r,o){if(gn(s,n)!=null)return e;const a=e.serverCache.isFiltered(),l=e.serverCache;if(i.value!=null){if(S(n)&&l.isFullyInitialized()||l.isCompleteForPath(n))return _n(t,e,n,l.getNode().getChild(n),s,r,a,o);if(S(n)){let c=new D(null);return l.getNode().forEachChild(Ve,(d,h)=>{c=c.set(new N(d),h)}),vi(t,e,n,c,s,r,a,o)}else return e}else{let c=new D(null);return i.foreach((d,h)=>{const f=L(n,d);l.isCompleteForPath(f)&&(c=c.set(d,l.getNode().getChild(f)))}),vi(t,e,n,c,s,r,a,o)}}function gu(t,e,n,i,s){const r=e.serverCache,o=Oo(e,r.getNode(),r.isFullyInitialized()||S(n),r.isFiltered());return Wo(t,o,n,i,Ho,s)}function _u(t,e,n,i,s,r){let o;if(gn(i,n)!=null)return e;{const a=new Vi(i,e,s),l=e.eventCache.getNode();let c;if(S(n)||C(n)===".priority"){let d;if(e.serverCache.isFullyInitialized())d=mn(i,Oe(e));else{const h=e.serverCache.getNode();m(h instanceof w,"serverChildren would be complete if leaf node"),d=ji(i,h)}d=d,c=t.filter.updateFullNode(l,d,r)}else{const d=C(n);let h=Gi(i,d,e.serverCache);h==null&&e.serverCache.isCompleteForChild(d)&&(h=l.getImmediateChild(d)),h!=null?c=t.filter.updateChild(l,d,h,R(n),a,r):e.eventCache.getNode().hasChild(d)?c=t.filter.updateChild(l,d,w.EMPTY_NODE,R(n),a,r):c=l,c.isEmpty()&&e.serverCache.isFullyInitialized()&&(o=mn(i,Oe(e)),o.isLeafNode()&&(c=t.filter.updateFullNode(c,o,r)))}return o=e.serverCache.isFullyInitialized()||gn(i,I())!=null,bt(e,c,o,t.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ts{constructor(e="",n=null,i={children:{},childCount:0}){this.name=e,this.parent=n,this.node=i}}function ns(t,e){let n=e instanceof N?e:new N(e),i=t,s=C(n);for(;s!==null;){const r=Ze(i.node.children,s)||{children:{},childCount:0};i=new ts(s,i,r),n=R(n),s=C(n)}return i}function lt(t){return t.node.value}function Qo(t,e){t.node.value=e,wi(t)}function Jo(t){return t.node.childCount>0}function Vu(t){return lt(t)===void 0&&!Jo(t)}function Rn(t,e){j(t.node.children,(n,i)=>{e(new ts(n,t,i))})}function Xo(t,e,n,i){n&&e(t),Rn(t,s=>{Xo(s,e,!0)})}function zu(t,e,n){let i=t.parent;for(;i!==null;){if(e(i))return!0;i=i.parent}return!1}function Gt(t){return new N(t.parent===null?t.name:Gt(t.parent)+"/"+t.name)}function wi(t){t.parent!==null&&Ku(t.parent,t.name,t)}function Ku(t,e,n){const i=Vu(n),s=oe(t.node.children,e);i&&s?(delete t.node.children[e],t.node.childCount--,wi(t)):!i&&!s&&(t.node.children[e]=n.node,t.node.childCount++,wi(t))}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yu=/[\[\].#$\/\u0000-\u001F\u007F]/,Zu=/[\[\].#$\u0000-\u001F\u007F]/,Yn=10*1024*1024,is=function(t){return typeof t=="string"&&t.length!==0&&!Yu.test(t)},ea=function(t){return typeof t=="string"&&t.length!==0&&!Zu.test(t)},Qu=function(t){return t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),ea(t)},ta=function(t){return t===null||typeof t=="string"||typeof t=="number"&&!En(t)||t&&typeof t=="object"&&oe(t,".sv")},Ci=function(t,e,n,i){xn(Qe(t,"value"),e,n)},xn=function(t,e,n){const i=n instanceof N?new md(n,t):n;if(e===void 0)throw new Error(t+"contains undefined "+Te(i));if(typeof e=="function")throw new Error(t+"contains a function "+Te(i)+" with contents = "+e.toString());if(En(e))throw new Error(t+"contains "+e.toString()+" "+Te(i));if(typeof e=="string"&&e.length>Yn/3&&Sn(e)>Yn)throw new Error(t+"contains a string greater than "+Yn+" utf8 bytes "+Te(i)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let s=!1,r=!1;if(j(e,(o,a)=>{if(o===".value")s=!0;else if(o!==".priority"&&o!==".sv"&&(r=!0,!is(o)))throw new Error(t+" contains an invalid key ("+o+") "+Te(i)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);gd(i,o),xn(t,a,i),_d(i)}),s&&r)throw new Error(t+' contains ".value" child '+Te(i)+" in addition to actual children.")}},Ju=function(t,e){let n,i;for(n=0;n<e.length;n++){i=e[n];const r=Nt(i);for(let o=0;o<r.length;o++)if(!(r[o]===".priority"&&o===r.length-1)){if(!is(r[o]))throw new Error(t+"contains an invalid key ("+r[o]+") in path "+i.toString()+`. Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`)}}e.sort(pd);let s=null;for(n=0;n<e.length;n++){if(i=e[n],s!==null&&J(s,i))throw new Error(t+"contains a path "+s.toString()+" that is ancestor of another path "+i.toString());s=i}},Xu=function(t,e,n,i){const s=Qe(t,"values");if(!(e&&typeof e=="object")||Array.isArray(e))throw new Error(s+" must be an object containing the children to replace.");const r=[];j(e,(o,a)=>{const l=new N(o);if(xn(s,a,L(n,l)),Mi(l)===".priority"&&!ta(a))throw new Error(s+"contains an invalid value for '"+l.toString()+"', which must be a valid Firebase priority (a string, finite number, server value, or null).");r.push(l)}),Ju(s,r)},ef=function(t,e,n){if(En(e))throw new Error(Qe(t,"priority")+"is "+e.toString()+", but must be a valid Firebase priority (a string, finite number, server value, or null).");if(!ta(e))throw new Error(Qe(t,"priority")+"must be a valid Firebase priority (a string, finite number, server value, or null).")},na=function(t,e,n,i){if(!ea(n))throw new Error(Qe(t,e)+'was an invalid path = "'+n+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},tf=function(t,e,n,i){n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),na(t,e,n)},gt=function(t,e){if(C(e)===".info")throw new Error(t+" failed = Can't modify data under /.info/")},nf=function(t,e){const n=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!is(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||n.length!==0&&!Qu(n))throw new Error(Qe(t,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sf{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function ss(t,e){let n=null;for(let i=0;i<e.length;i++){const s=e[i],r=s.getPath();n!==null&&!Li(r,n.path)&&(t.eventLists_.push(n),n=null),n===null&&(n={events:[],path:r}),n.events.push(s)}n&&t.eventLists_.push(n)}function ia(t,e,n){ss(t,n),sa(t,i=>Li(i,e))}function pe(t,e,n){ss(t,n),sa(t,i=>J(i,e)||J(e,i))}function sa(t,e){t.recursionDepth_++;let n=!0;for(let i=0;i<t.eventLists_.length;i++){const s=t.eventLists_[i];if(s){const r=s.path;e(r)?(rf(t.eventLists_[i]),t.eventLists_[i]=null):n=!1}}n&&(t.eventLists_=[]),t.recursionDepth_--}function rf(t){for(let e=0;e<t.events.length;e++){const n=t.events[e];if(n!==null){t.events[e]=null;const i=n.getEventRunner();yt&&q("event: "+n.toString()),ot(i)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const of="repo_interrupt",af=25;class lf{constructor(e,n,i,s){this.repoInfo_=e,this.forceRestClient_=n,this.authTokenProvider_=i,this.appCheckProvider_=s,this.dataUpdateCount=0,this.statsListener_=null,this.eventQueue_=new sf,this.nextWriteId_=1,this.interceptServerDataCallback_=null,this.onDisconnect_=fn(),this.transactionQueueTree_=new ts,this.persistentConnection_=null,this.key=this.repoInfo_.toURLString()}toString(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host}}function cf(t,e,n){if(t.stats_=Di(t.repoInfo_),t.forceRestClient_||Bh())t.server_=new un(t.repoInfo_,(i,s,r,o)=>{_r(t,i,s,r,o)},t.authTokenProvider_,t.appCheckProvider_),setTimeout(()=>yr(t,!0),0);else{if(typeof n<"u"&&n!==null){if(typeof n!="object")throw new Error("Only objects are supported for option databaseAuthVariableOverride");try{U(n)}catch(i){throw new Error("Invalid authOverride provided: "+i)}}t.persistentConnection_=new de(t.repoInfo_,e,(i,s,r,o)=>{_r(t,i,s,r,o)},i=>{yr(t,i)},i=>{df(t,i)},t.authTokenProvider_,t.appCheckProvider_,n),t.server_=t.persistentConnection_}t.authTokenProvider_.addTokenChangeListener(i=>{t.server_.refreshAuthToken(i)}),t.appCheckProvider_.addTokenChangeListener(i=>{t.server_.refreshAppCheckToken(i.token)}),t.statsReporter_=jh(t.repoInfo_,()=>new qd(t.stats_,t.server_)),t.infoData_=new $d,t.infoSyncTree_=new pr({startListening:(i,s,r,o)=>{let a=[];const l=t.infoData_.getNode(i._path);return l.isEmpty()||(a=An(t.infoSyncTree_,i._path,l),setTimeout(()=>{o("ok")},0)),a},stopListening:()=>{}}),os(t,"connected",!1),t.serverSyncTree_=new pr({startListening:(i,s,r,o)=>(t.server_.listen(i,r,s,(a,l)=>{const c=o(a,l);pe(t.eventQueue_,i._path,c)}),[]),stopListening:(i,s)=>{t.server_.unlisten(i,s)}})}function hf(t){const n=t.infoData_.getNode(new N(".info/serverTimeOffset")).val()||0;return new Date().getTime()+n}function rs(t){return Uu({timestamp:hf(t)})}function _r(t,e,n,i,s){t.dataUpdateCount++;const r=new N(e);n=t.interceptServerDataCallback_?t.interceptServerDataCallback_(e,n):n;let o=[];if(s)if(i){const l=rn(n,c=>$(c));o=Fu(t.serverSyncTree_,r,l,s)}else{const l=$(n);o=Lu(t.serverSyncTree_,r,l,s)}else if(i){const l=rn(n,c=>$(c));o=Du(t.serverSyncTree_,r,l)}else{const l=$(n);o=An(t.serverSyncTree_,r,l)}let a=r;o.length>0&&(a=Pn(t,r)),pe(t.eventQueue_,a,o)}function yr(t,e){os(t,"connected",e),e===!1&&ff(t)}function df(t,e){j(e,(n,i)=>{os(t,n,i)})}function os(t,e,n){const i=new N("/.info/"+e),s=$(n);t.infoData_.updateSnapshot(i,s);const r=An(t.infoSyncTree_,i,s);pe(t.eventQueue_,i,r)}function ra(t){return t.nextWriteId_++}function uf(t,e,n,i,s){as(t,"set",{path:e.toString(),value:n,priority:i});const r=rs(t),o=$(n,i),a=Ki(t.serverSyncTree_,e),l=Zo(o,a,r),c=ra(t),d=Vo(t.serverSyncTree_,e,l,c,!0);ss(t.eventQueue_,d),t.server_.put(e.toString(),o.val(!0),(f,g)=>{const _=f==="ok";_||K("set at "+e+" failed: "+f);const k=Ne(t.serverSyncTree_,c,!_);pe(t.eventQueue_,e,k),tt(t,s,f,g)});const h=ha(t,e);Pn(t,h),pe(t.eventQueue_,h,[])}function ff(t){as(t,"onDisconnectEvents");const e=rs(t),n=fn();pi(t.onDisconnect_,I(),(s,r)=>{const o=Gu(s,r,t.serverSyncTree_,e);at(n,s,o)});let i=[];pi(n,I(),(s,r)=>{i=i.concat(An(t.serverSyncTree_,s,r));const o=ha(t,s);Pn(t,o)}),t.onDisconnect_=fn(),pe(t.eventQueue_,I(),i)}function pf(t,e,n){t.server_.onDisconnectCancel(e.toString(),(i,s)=>{i==="ok"&&fi(t.onDisconnect_,e),tt(t,n,i,s)})}function vr(t,e,n,i){const s=$(n);t.server_.onDisconnectPut(e.toString(),s.val(!0),(r,o)=>{r==="ok"&&at(t.onDisconnect_,e,s),tt(t,i,r,o)})}function mf(t,e,n,i,s){const r=$(n,i);t.server_.onDisconnectPut(e.toString(),r.val(!0),(o,a)=>{o==="ok"&&at(t.onDisconnect_,e,r),tt(t,s,o,a)})}function gf(t,e,n,i){if(si(n)){q("onDisconnect().update() called with empty data.  Don't do anything."),tt(t,i,"ok",void 0);return}t.server_.onDisconnectMerge(e.toString(),n,(s,r)=>{s==="ok"&&j(n,(o,a)=>{const l=$(a);at(t.onDisconnect_,L(e,o),l)}),tt(t,i,s,r)})}function _f(t,e,n){let i;C(e._path)===".info"?i=mr(t.infoSyncTree_,e,n):i=mr(t.serverSyncTree_,e,n),ia(t.eventQueue_,e._path,i)}function br(t,e,n){let i;C(e._path)===".info"?i=bi(t.infoSyncTree_,e,n):i=bi(t.serverSyncTree_,e,n),ia(t.eventQueue_,e._path,i)}function yf(t){t.persistentConnection_&&t.persistentConnection_.interrupt(of)}function as(t,...e){let n="";t.persistentConnection_&&(n=t.persistentConnection_.id+":"),q(n,...e)}function tt(t,e,n,i){e&&ot(()=>{if(n==="ok")e(null);else{const s=(n||"error").toUpperCase();let r=s;i&&(r+=": "+i);const o=new Error(r);o.code=s,e(o)}})}function oa(t,e,n){return Ki(t.serverSyncTree_,e,n)||w.EMPTY_NODE}function ls(t,e=t.transactionQueueTree_){if(e||Dn(t,e),lt(e)){const n=la(t,e);m(n.length>0,"Sending zero length transaction queue"),n.every(s=>s.status===0)&&vf(t,Gt(e),n)}else Jo(e)&&Rn(e,n=>{ls(t,n)})}function vf(t,e,n){const i=n.map(c=>c.currentWriteId),s=oa(t,e,i);let r=s;const o=s.hash();for(let c=0;c<n.length;c++){const d=n[c];m(d.status===0,"tryToSendTransactionQueue_: items in queue should all be run."),d.status=1,d.retryCount++;const h=V(e,d.path);r=r.updateChild(h,d.currentOutputSnapshotRaw)}const a=r.val(!0),l=e;t.server_.put(l.toString(),a,c=>{as(t,"transaction put response",{path:l.toString(),status:c});let d=[];if(c==="ok"){const h=[];for(let f=0;f<n.length;f++)n[f].status=2,d=d.concat(Ne(t.serverSyncTree_,n[f].currentWriteId)),n[f].onComplete&&h.push(()=>n[f].onComplete(null,!0,n[f].currentOutputSnapshotResolved)),n[f].unwatcher();Dn(t,ns(t.transactionQueueTree_,e)),ls(t,t.transactionQueueTree_),pe(t.eventQueue_,e,d);for(let f=0;f<h.length;f++)ot(h[f])}else{if(c==="datastale")for(let h=0;h<n.length;h++)n[h].status===3?n[h].status=4:n[h].status=0;else{K("transaction at "+l.toString()+" failed: "+c);for(let h=0;h<n.length;h++)n[h].status=4,n[h].abortReason=c}Pn(t,e)}},o)}function Pn(t,e){const n=aa(t,e),i=Gt(n),s=la(t,n);return bf(t,s,i),i}function bf(t,e,n){if(e.length===0)return;const i=[];let s=[];const o=e.filter(a=>a.status===0).map(a=>a.currentWriteId);for(let a=0;a<e.length;a++){const l=e[a],c=V(n,l.path);let d=!1,h;if(m(c!==null,"rerunTransactionsUnderNode_: relativePath should not be null."),l.status===4)d=!0,h=l.abortReason,s=s.concat(Ne(t.serverSyncTree_,l.currentWriteId,!0));else if(l.status===0)if(l.retryCount>=af)d=!0,h="maxretry",s=s.concat(Ne(t.serverSyncTree_,l.currentWriteId,!0));else{const f=oa(t,l.path,o);l.currentInputSnapshot=f;const g=e[a].update(f.val());if(g!==void 0){xn("transaction failed: Data returned ",g,l.path);let _=$(g);typeof g=="object"&&g!=null&&oe(g,".priority")||(_=_.updatePriority(f.getPriority()));const O=l.currentWriteId,B=rs(t),Y=Zo(_,f,B);l.currentOutputSnapshotRaw=_,l.currentOutputSnapshotResolved=Y,l.currentWriteId=ra(t),o.splice(o.indexOf(O),1),s=s.concat(Vo(t.serverSyncTree_,l.path,Y,l.currentWriteId,l.applyLocally)),s=s.concat(Ne(t.serverSyncTree_,O,!0))}else d=!0,h="nodata",s=s.concat(Ne(t.serverSyncTree_,l.currentWriteId,!0))}pe(t.eventQueue_,n,s),s=[],d&&(e[a].status=2,function(f){setTimeout(f,Math.floor(0))}(e[a].unwatcher),e[a].onComplete&&(h==="nodata"?i.push(()=>e[a].onComplete(null,!1,e[a].currentInputSnapshot)):i.push(()=>e[a].onComplete(new Error(h),!1,null))))}Dn(t,t.transactionQueueTree_);for(let a=0;a<i.length;a++)ot(i[a]);ls(t,t.transactionQueueTree_)}function aa(t,e){let n,i=t.transactionQueueTree_;for(n=C(e);n!==null&&lt(i)===void 0;)i=ns(i,n),e=R(e),n=C(e);return i}function la(t,e){const n=[];return ca(t,e,n),n.sort((i,s)=>i.order-s.order),n}function ca(t,e,n){const i=lt(e);if(i)for(let s=0;s<i.length;s++)n.push(i[s]);Rn(e,s=>{ca(t,s,n)})}function Dn(t,e){const n=lt(e);if(n){let i=0;for(let s=0;s<n.length;s++)n[s].status!==2&&(n[i]=n[s],i++);n.length=i,Qo(e,n.length>0?n:void 0)}Rn(e,i=>{Dn(t,i)})}function ha(t,e){const n=Gt(aa(t,e)),i=ns(t.transactionQueueTree_,e);return zu(i,s=>{Zn(t,s)}),Zn(t,i),Xo(i,s=>{Zn(t,s)}),n}function Zn(t,e){const n=lt(e);if(n){const i=[];let s=[],r=-1;for(let o=0;o<n.length;o++)n[o].status===3||(n[o].status===1?(m(r===o-1,"All SENT items should be at beginning of queue."),r=o,n[o].status=3,n[o].abortReason="set"):(m(n[o].status===0,"Unexpected transaction status in abort"),n[o].unwatcher(),s=s.concat(Ne(t.serverSyncTree_,n[o].currentWriteId,!0)),n[o].onComplete&&i.push(n[o].onComplete.bind(null,new Error("set"),!1,null))));r===-1?Qo(e,void 0):n.length=r+1,pe(t.eventQueue_,Gt(e),s);for(let o=0;o<i.length;o++)ot(i[o])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kf{constructor(e,n){this._repo=e,this._path=n}cancel(){const e=new ce;return pf(this._repo,this._path,e.wrapCallback(()=>{})),e.promise}remove(){gt("OnDisconnect.remove",this._path);const e=new ce;return vr(this._repo,this._path,null,e.wrapCallback(()=>{})),e.promise}set(e){gt("OnDisconnect.set",this._path),Ci("OnDisconnect.set",e,this._path);const n=new ce;return vr(this._repo,this._path,e,n.wrapCallback(()=>{})),n.promise}setWithPriority(e,n){gt("OnDisconnect.setWithPriority",this._path),Ci("OnDisconnect.setWithPriority",e,this._path),ef("OnDisconnect.setWithPriority",n);const i=new ce;return mf(this._repo,this._path,e,n,i.wrapCallback(()=>{})),i.promise}update(e){gt("OnDisconnect.update",this._path),Xu("OnDisconnect.update",e,this._path);const n=new ce;return gf(this._repo,this._path,e,n.wrapCallback(()=>{})),n.promise}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cs{constructor(e,n,i,s){this._repo=e,this._path=n,this._queryParams=i,this._orderByCalled=s}get key(){return S(this._path)?null:Mi(this._path)}get ref(){return new me(this._repo,this._path)}get _queryIdentifier(){const e=ir(this._queryParams),n=xi(e);return n==="{}"?"default":n}get _queryObject(){return ir(this._queryParams)}isEqual(e){if(e=rt(e),!(e instanceof cs))return!1;const n=this._repo===e._repo,i=Li(this._path,e._path),s=this._queryIdentifier===e._queryIdentifier;return n&&i&&s}toJSON(){return this.toString()}toString(){return this._repo.toString()+fd(this._path)}}class me extends cs{constructor(e,n){super(e,n,new Hi,!1)}get parent(){const e=ko(this._path);return e===null?null:new me(this._repo,e)}get root(){let e=this;for(;e.parent!==null;)e=e.parent;return e}}class Mt{constructor(e,n,i){this._node=e,this.ref=n,this._index=i}get priority(){return this._node.getPriority().val()}get key(){return this.ref.key}get size(){return this._node.numChildren()}child(e){const n=new N(e),i=wn(this.ref,e);return new Mt(this._node.getChild(n),i,M)}exists(){return!this._node.isEmpty()}exportVal(){return this._node.val(!0)}forEach(e){return this._node.isLeafNode()?!1:!!this._node.forEachChild(this._index,(i,s)=>e(new Mt(s,wn(this.ref,i),M)))}hasChild(e){const n=new N(e);return!this._node.getChild(n).isEmpty()}hasChildren(){return this._node.isLeafNode()?!1:!this._node.isEmpty()}toJSON(){return this.exportVal()}val(){return this._node.val()}}function Ie(t,e){return t=rt(t),t._checkNotDeleted("ref"),e!==void 0?wn(t._root,e):t._root}function wn(t,e){return t=rt(t),C(t._path)===null?tf("child","path",e):na("child","path",e),new me(t._repo,L(t._path,e))}function Tf(t){return t=rt(t),new kf(t._repo,t._path)}function fa(t,e){t=rt(t),gt("set",t._path),Ci("set",e,t._path);const n=new ce;return uf(t._repo,t._path,e,null,n.wrapCallback(()=>{})),n.promise}class hs{constructor(e){this.callbackContext=e}respondsTo(e){return e==="value"}createEvent(e,n){const i=n._queryParams.getIndex();return new da("value",this,new Mt(e.snapshotNode,new me(n._repo,n._path),i))}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,null)}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new ua(this,e,n):null}matches(e){return e instanceof hs?!e.callbackContext||!this.callbackContext?!0:e.callbackContext.matches(this.callbackContext):!1}hasAnyCallback(){return this.callbackContext!==null}}class ds{constructor(e,n){this.eventType=e,this.callbackContext=n}respondsTo(e){let n=e==="children_added"?"child_added":e;return n=n==="children_removed"?"child_removed":n,this.eventType===n}createCancelEvent(e,n){return this.callbackContext.hasCancelCallback?new ua(this,e,n):null}createEvent(e,n){m(e.childName!=null,"Child events should have a childName.");const i=wn(new me(n._repo,n._path),e.childName),s=n._queryParams.getIndex();return new da(e.type,this,new Mt(e.snapshotNode,i,s),e.prevName)}getEventRunner(e){return e.getEventType()==="cancel"?()=>this.callbackContext.onCancel(e.error):()=>this.callbackContext.onValue(e.snapshot,e.prevName)}matches(e){return e instanceof ds?this.eventType===e.eventType&&(!this.callbackContext||!e.callbackContext||this.callbackContext.matches(e.callbackContext)):!1}hasAnyCallback(){return!!this.callbackContext}}function On(t,e,n,i,s){let r;if(typeof i=="object"&&(r=void 0,s=i),typeof i=="function"&&(r=i),s&&s.onlyOnce){const l=n,c=(d,h)=>{br(t._repo,t,a),l(d,h)};c.userCallback=n.userCallback,c.context=n.context,n=c}const o=new Ef(n,r||void 0),a=e==="value"?new hs(o):new ds(e,o);return _f(t._repo,t,a),()=>br(t._repo,t,a)}function If(t,e,n,i){return On(t,"value",e,n,i)}function Cr(t,e,n,i){return On(t,"child_added",e,n,i)}function Af(t,e,n,i){return On(t,"child_changed",e,n,i)}function Nf(t,e,n,i){return On(t,"child_removed",e,n,i)}Eu(me);Ru(me);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function Bf(t){Eh(hh),ln(new Tt("database",(e,{instanceIdentifier:n})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return Df(i,s,r,n)},"PUBLIC").setMultipleInstances(!0)),je(Hs,Ws,t),je(Hs,Ws,"esm2020")}de.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};de.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};Bf();const Me=!!(ni.apiKey&&ni.databaseURL);let te=null;if(Me){const t=Jr(ni);te=Ff(t)}const Cn="matrix-rpg-characters-v1",us=["home","learn","jack-in"],fs=["identity","abilities","skills","loadout","notes","comms"],Hf=["Common Sense","Focus","Agility","Strength","Endurance","CyberZen"],Wf=["None","Light","Moderate","Serious","Critical","Incapacitated","Dead"],Uf=["RSI Hacker","Operator","Pilot","Captain","Crew","Nomad","Surface Human"],qf=["None","Temporary","Permanent"],Ei="matrix-rpg-opensea-key-v1",pa=[{slug:"the-matrix-avatars-red-polygon",chain:"polygon",filter:"red",label:"Red Pill"},{slug:"the-matrix-avatars-blue-polygon",chain:"polygon",filter:"blue",label:"Blue Pill"},{slug:"the-matrix-avatars",chain:"ethereum",filter:"base",label:"Base Avatar"}],jf={"0xc37d61ad831dbc979469dc48a7f55141e2e27f03":"red","0xcc16d5f112d2d6b7d4572eb191a59f22aaf87d02":"blue","0x495f947276749ce646f68ac8c248420045cb7b5e":"base"},ma="matrix-rpg-nft-bookmarks-v1",ps="matrix-rpg-messages-v1";function ki(){return localStorage.getItem(Ei)||""}function Sr(t){t?localStorage.setItem(Ei,t):localStorage.removeItem(Ei)}function Gf(){try{return JSON.parse(localStorage.getItem(ma)||"[]")}catch{return[]}}function Vf(){localStorage.setItem(ma,JSON.stringify(u.nftBookmarks))}function ga(){try{return JSON.parse(localStorage.getItem(ps)||"[]")}catch{return[]}}function Lt(){localStorage.setItem(ps,JSON.stringify(u.messages)),zf()}function zf(){let t=!1;u.characters=u.characters.map(e=>{const n=e.homeShip||"",i=u.messages.filter(o=>(o.shipName||"")!==n?!1:e.role==="Operator"?!0:o.to==="__all__"||o.to===e.id||o.fromCharId===e.id),s=e.messageLog||[],r=i.filter(o=>!s.find(a=>a.id===o.id));return r.length?(t=!0,{...e,messageLog:[...s,...r]}):e}),t&&Ue(u.characters)}function nt(t){return`${t.contract||""}:${t.identifier}`}function Kf(t){return u.nftBookmarks.some(e=>nt(e)===nt(t))}function _a(t){var e;return((e=u.characters.find(n=>n.id===t))==null?void 0:e.role)==="Operator"}function ya(t){const e=u.characters.find(i=>i.id===t),n=(e==null?void 0:e.homeShip)||"";return _a(t)?u.messages.filter(i=>(i.to==="__operator__"||i.to===t)&&(i.shipName||"")===n):u.messages.filter(i=>(i.to==="__all__"||i.to===t)&&(i.shipName||"")===n)}function va(t){return ya(t).filter(e=>!e.readBy.includes(t)).length}function Yf(t){let e=!1;const n=_a(t);u.messages=u.messages.map(i=>(n?i.to==="__operator__"||i.to===t:i.to==="__all__"||i.to===t)&&!i.readBy.includes(t)?(e=!0,{...i,readBy:[...i.readBy,t]}):i),e&&Lt()}function Er(t,e,n,i,s=""){const r={id:`msg-${Date.now()}-${Math.random().toString(16).slice(2,6)}`,from:t,fromCharId:e,to:n,shipName:s,body:i,sentAt:new Date().toISOString(),readBy:[]};Me&&te?(u.messages=[...u.messages,r],A(),fa(Ie(te,`matrix-rpg/messages/${r.id}`),{...r,readBy:{}}).catch(o=>{console.error("Firebase write failed:",o),u.status="Transmission failed — check your connection.",A()}),Lt()):(u.messages=[...u.messages,r],Lt(),A())}function ba(t){if(!Me||!te)return;const e={id:t.id,profileName:t.profileName||"Unknown",callSign:t.callSign||"",role:t.role||"",homeShip:t.homeShip||"",phoneOn:u.phoneOn,lastSeen:Date.now()},n=Ie(te,`matrix-rpg/sessions/${t.id}`);Tf(n).remove(),fa(n,e).catch(i=>{console.error("Session register failed:",i),String(i).includes("PERMISSION_DENIED")&&(u.status='Firebase rules block sessions — add "sessions" to your Realtime Database rules (see README).',A())})}function Zf(t){const e=nt(t),n=u.nftBookmarks.findIndex(i=>nt(i)===e);n>=0?u.nftBookmarks=[...u.nftBookmarks.slice(0,n),...u.nftBookmarks.slice(n+1)]:u.nftBookmarks=[...u.nftBookmarks,{...t,bookmarkedAt:new Date().toISOString()}],Vf(),A()}function Ft(){return`char-${Date.now()}-${Math.random().toString(16).slice(2,8)}`}function ms(){return{id:Ft(),name:"",rating:0,attribute:"Agility",specialization:"",downloadType:"None",notes:""}}function gs(){return{id:Ft(),name:"",rating:0,notes:""}}function Ke(){return{id:Ft(),profileName:"New Redpill",callSign:"",realName:"",path:"",role:"RSI Hacker",affiliation:"Zion Resistance",homeShip:"",origin:"",redPillChoice:"Red Pill",background:"",motivation:"",appearance:"",notes:"",attributes:{commonSense:1,focus:1,agility:1,strength:1,endurance:1,cyberZen:0,giftUnlocked:!1},damage:"None",experience:0,karma:0,hardlines:1,matrixFeats:[gs()],skills:Array.from({length:6},()=>ms()),gear:{realWorld:"",matrixLoadout:"",contacts:"",vehicles:"",hardlineNotes:""},nft:{walletAddress:"",collectionNotes:""},messageLog:[],updatedAt:new Date().toISOString()}}function _s(t={}){const e=Ke();return{...e,...t,id:t.id||e.id,profileName:t.profileName||e.profileName,attributes:{...e.attributes,...t.attributes},gear:{...e.gear,...t.gear},nft:{...e.nft,...t.nft},skills:Array.isArray(t.skills)&&t.skills.length?t.skills.map(n=>({...ms(),...n,id:n.id||Ft()})):e.skills,matrixFeats:Array.isArray(t.matrixFeats)&&t.matrixFeats.length?t.matrixFeats.map(n=>({...gs(),...n,id:n.id||Ft()})):e.matrixFeats,messageLog:Array.isArray(t.messageLog)?t.messageLog:[],updatedAt:t.updatedAt||e.updatedAt}}function wa(){const t=window.location.hash.replace("#","")||"home";return us.includes(t)?t:"home"}function Ca(){try{const t=window.localStorage.getItem(Cn);if(!t){const n=Ke();return window.localStorage.setItem(Cn,JSON.stringify([n])),[n]}const e=JSON.parse(t);return!Array.isArray(e)||!e.length?[Ke()]:e.map(n=>_s(n))}catch{return[Ke()]}}function Ue(t){window.localStorage.setItem(Cn,JSON.stringify(t))}const u={characters:Ca(),selectedId:null,status:"Local storage ready.",route:wa(),sheetTab:"identity",nftLoading:!1,nftItems:[],nftError:null,nftFilter:"all",nftMode:"wallet",nftContractItems:[],nftContractNext:null,nftContractAddress:"",nftBookmarks:Gf(),phoneOn:!1,messages:ga(),firebaseConnected:!1,sessionChars:{}};var Ir;u.selectedId=((Ir=u.characters[0])==null?void 0:Ir.id)??null;window.addEventListener("hashchange",()=>{const t=wa();t!==u.route&&(u.route=t,A(!0))});let Qn=!1;function ft(t=!1){Qn||(Qn=!0,requestAnimationFrame(()=>{if(Qn=!1,A(),t&&u.phoneOn){const e=document.getElementById("phone-screen");e&&(e.scrollTop=e.scrollHeight)}}))}if(Me&&te){If(Ie(te,".info/connected"),e=>{const n=u.firebaseConnected;u.firebaseConnected=e.val()===!0,A(),u.firebaseConnected&&!n&&requestAnimationFrame(()=>{const i=document.querySelector(".comms-conn-banner");i&&El(i)})}),Cr(Ie(te,"matrix-rpg/messages"),e=>{const n=e.val();if(!n)return;const i=n.readBy?Object.keys(n.readBy):[],s={...n,id:e.key,readBy:i};u.messages.find(r=>r.id===s.id)||(u.messages=[...u.messages,s],Lt(),ft(u.sheetTab==="comms"))});const t=e=>{console.error("Sessions listener denied:",e),u.status='Firebase rules block sessions — add "sessions" to your Realtime Database rules (see README).',A()};Cr(Ie(te,"matrix-rpg/sessions"),e=>{e.key&&e.val()&&(u.sessionChars[e.key]=e.val(),ft())},t),Af(Ie(te,"matrix-rpg/sessions"),e=>{e.key&&e.val()&&(u.sessionChars[e.key]=e.val(),ft())},t),Nf(Ie(te,"matrix-rpg/sessions"),e=>{e.key&&(delete u.sessionChars[e.key],ft())},t)}else window.addEventListener("storage",t=>{t.key===ps&&(u.messages=ga(),ft(u.sheetTab==="comms")),t.key===Cn&&(u.characters=Ca(),A())});function Re(){return u.characters.find(t=>t.id===u.selectedId)??u.characters[0]}function Ee(t){u.status=t}function Yt(t,e={}){us.includes(t)&&(u.route=t,e.sheetTab&&fs.includes(e.sheetTab)&&(u.sheetTab=e.sheetTab),window.location.hash!==`#${t}`&&(window.location.hash=t),A(!0))}function Qf(t){fs.includes(t)&&(u.sheetTab=t,t==="comms"&&ba(Re()),A(!0))}function le(t,e=!0){u.characters=u.characters.map(n=>{if(n.id!==u.selectedId)return n;const i=t(structuredClone(n));return i.updatedAt=new Date().toISOString(),_s(i)}),Ue(u.characters),e&&A()}function se({label:t,name:e,value:n,type:i="text",placeholder:s="",min:r=0,max:o=99}){return`
  ...
  `}function op(){const t=Re(),e=va(t.id),n={identity:"Identity",abilities:"Abilities",skills:"Skills",loadout:"Loadout",notes:"Notes",comms:`Comms${!u.phoneOn&&e>0?` <span class="tab-badge">${e}</span>`:""}`};return fs.map(i=>`<button class="sheet-tab ${u.sheetTab===i?"is-active":""}" data-sheet-tab="${i}">${n[i]}</button>`).join("")}function ap(t){return`
  ...
  `}function cp(t){return`
    <section class="sheet-card sheet-card-wide">
      ...
      <div class="repeatable-list">
        ${t.skills.map((e,n)=>{var s;const i=((s=Xt.find(r=>r.name===e.name))==null?void 0:s.description)??"";return`
      ...
      ${u.nftMode==="wallet"?`
        <div class="field-grid two-up nft-viewer-inputs">
          ...
          <label class="field">
            ...
            <input id="nft-api-key" type="password" value="${y(ki())}" placeholder="Free key at opensea.io/developers" autocomplete="off" />
          </label>
        </div>
  ...
  `}function Jt(t,e){var o;const n=(o=t.closest(".skill-name-wrapper"))==null?void 0:o.querySelector(".skill-suggestions");if(!n)return;const i=a=>`<button class="skill-suggestion" data-suggest-value="${y(a)}">
...
${d}`:d,it(e),r.hidden=!0,t.focus()})}function mp(t,e){var a;const n=(a=t.closest(".skill-name-wrapper"))==null?void 0:a.querySelector("[data-skill-suggestions]");if(!n)return;const i=document.querySelector(`[data-skill-description="${e}"]`),s=l=>`<button class="skill-suggestion"
  ...
  `}function bp(t,e){return u.nftLoading?'<div class="nft-status-msg">Fetching from OpenSea…</div>':u.nftError&&!t.length?`<div class="nft-status-msg nft-status-error">${y(u.nftError)}</div>`:t.length?`<div class="nft-token-grid">${t.map(Ti).join("")}</div>`:`<div class="nft-status-msg">${y(e)}</div>`}function wp(){var e;if(u.nftMode==="bookmarks")return u.nftBookmarks.length?`<div class="nft-token-grid">${u.nftBookmarks.map(Ti).join("")}</div>`:'<div class="nft-status-msg">No bookmarks yet. Browse your wallet or a contract and click ☆ to save NFTs here.</div>';if(u.nftMode==="contract"){const n=bp(u.nftContractItems,"Enter a contract address and click Browse."),i=u.nftContractNext&&!u.nftLoading?`<div class="nft-load-more-row">
         ...
         </div>`:u.nftContractItems.length>0?`<div class="nft-count-row"><span class="nft-count">${u.nftContractItems.length} NFTs loaded</span></div>`:"";return n+i}const t=u.nftFilter==="all"?u.nftItems:u.nftItems.filter(n=>n._filter===u.nftFilter);return u.nftLoading?'<div class="nft-status-msg">Fetching wallet NFTs from OpenSea…</div>':u.nftError&&!u.nftItems.length?`<div class="nft-status-msg nft-status-error">${y(u.nftError)}</div>`:u.nftItems.length?t.length?`<div class="nft-token-grid">${t.map(Ti).join("")}</div>`:`<div class="nft-status-msg">No ${((e=pa.find(i=>i.filter===u.nftFilter))==null?void 0:e.label)??"this collection"} NFTs in this wallet.</div>`:""}function Cp(t){const e=va(t);return`
